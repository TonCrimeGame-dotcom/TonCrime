  ...
  const api = {
    ...
    async _pollMatchStateOnce() {
      ...
      if (winnerId) {
        ...
        this._finish(!!didWin, this._text("matchOver", "Mac bitti"), {
          notify: !!didWin,
          reasonKey: "matchOver",
        });
        return;
      ...
      if ((status === "cancelled" || status === "canceled" || status === "abandoned" || status === "closed" || status === "expired") && !this._state?.finished) {
